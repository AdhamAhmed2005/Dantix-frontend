          ...
          <div className="border-2 border-dashed border-gray-400 rounded-2xl p-8 flex flex-col items-center gap-6 bg-white">
            <div className="w-15 h-15 text-gray-700">
              <svg viewBox="0 0 60 60" fill="currentColor">
                <path
                  d="M30 10v30m0 0l-8-8m8 8l8-8M10 45h40"
                  stroke="currentColor"
                  strokeWidth="2"
                  fill="none"
                  strokeLinecap="round"
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="bg-white border border-gray-300 rounded-lg px-4 py-2.5 flex items-center justify-between">
                <div className="flex items-center gap-5">
                  <svg
                    className="w-7.5 h-7.5 text-gray-700 shrink-0"
                    viewBox="0 0 30 30"
                    fill="currentColor"
                  >
                    <path
                      d="M8 4h14l4 4v14a2 2 0 01-2 2H8a2 2 0 01-2-2V6a2 2 0 012-2z"
                      stroke="currentColor"
                      strokeWidth="1.5"
                      fill="none"
                    />
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2.5">
                ...
                >
                  ...
                  />
                  <path
                    d="M4.85 7.27l1.82 1.82 3.64-3.64"
                    stroke="currentColor"
                    strokeWidth="1.26"
                    fill="none"
                    strokeLinecap="round"
              ...
              <div className="flex items-center gap-2.5">
                ...
                >
                  <path
                    d="M4.85 4.85l4.84 4.84m0-4.84l-4.84 4.84"
                    stroke="currentColor"
                    strokeWidth="1.26"
                    strokeLinecap="round"
                  />
                  <path
                    d="M7.27 1.63a5.64 5.64 0 100 11.28 5.64 5.64 0 000-11.28z"
                    stroke="currentColor"
                    strokeWidth="1.26"
                  />
                </svg>
